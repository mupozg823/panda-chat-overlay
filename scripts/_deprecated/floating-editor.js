  ...
  const configs = {
    bubble: {
      ...
      controls: [
        ...
        { label: "말풍선꼬리", type: "toggle", id: "bubbleTail" },
        {
          label: "꼬리크기",
          type: "range",
          id: "bubbleTailSize",
        ...
        },
        {
          ...
          options: [
            { value: "none", text: "없음" },
            { value: "fadeIn", text: "페이드인" },
            { value: "slideUp", text: "슬라이드업" },
            { value: "slideLeft", text: "슬라이드좌" },
          ],
        },
      ],
    },
    nick: {
      ...
      controls: [
        ...
        { label: "닉프레임", type: "toggle", id: "nameFrameEnabled" },
        {
          label: "프레임색1",
          type: "color",
          id: "nameFrameColor1",
          hex: "nameFrameColor1Hex",
        },
        {
          label: "프레임색2",
          type: "color",
          id: "nameFrameColor2",
          hex: "nameFrameColor2Hex",
        },
        {
          label: "프레임투명도",
          type: "range",
    ...
    donation: {
      ...
      controls: [
        ...
        },
        {
          label: "이미지그림자",
          type: "range",
          id: "donationImgShadow",
          min: 0,
          max: 20,
          unit: "px",
        },
        { label: "그라데이션", type: "toggle", id: "donationUseGradient" },
        {
          label: "그라데이션시작",
          type: "color",
          id: "donationGradStart",
          hex: "donationGradStartHex",
        },
        {
          label: "그라데이션끝",
          type: "color",
          id: "donationGradEnd",
          hex: "donationGradEndHex",
        },
        { label: "글로우", type: "toggle", id: "donationGlow" },
        {
          label: "글로우색",
          type: "color",
          id: "donationGlowColor",
          hex: "donationGlowHex",
        },
        {
          label: "글로우크기",

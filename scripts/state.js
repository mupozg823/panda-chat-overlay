...
function getValues() {
  const v = {
    ...
    badgeOpacity: +document.getElementById("badgeOpacity").value,
    badgeScale: +document.getElementById("badgeScale").value,
    badgeGrayscale: +document.getElementById("badgeGrayscale").value,
    bubbleTail: getToggle("bubbleTail"),
    bubbleTailSize: +document.getElementById("bubbleTailSize").value,
    animationType: document.getElementById("animationType").value,
    donationImgRadius: +document.getElementById("donationImgRadius").value,
    donationImgBorder: +document.getElementById("donationImgBorder").value,
    donationImgShadow: +document.getElementById("donationImgShadow").value,
